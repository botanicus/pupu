module Merb
  module Generators
    class MoostackGenerator < AppGenerator
      #
      # ==== Paths
      #

      def self.source_root
        File.join(super, 'application', 'moostack')
      end
    ...
    DESC
      ...
      file :mootools do |file|
        file.source = File.join(common_templates_dir, 'mootools.js')
        file.destination = 'public/javascripts/mootools.js'
      end
    ...
    add 'moostack',   MerbArStackGenerator
  end
end
